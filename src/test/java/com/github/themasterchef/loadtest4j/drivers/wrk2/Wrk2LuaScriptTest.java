...
public class Wrk2LuaScriptTest {
    @Test
    public void testScript() {
        final Wrk2LuaScript script = new Wrk2LuaScript("{}", Collections.singletonMap("Content-Type", "application/json"), "POST");
    ...
    public void testMinimalScript() {
        final Wrk2LuaScript script = new Wrk2LuaScript("{}", Collections.emptyMap(), "GET");
